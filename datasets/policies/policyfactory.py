...
class PolicyFactorySimple:
    policy: Union[TopTwoTSPolicy, TSPostDiffPolicy, TSContextualPolicySimple]
    ...
    def get_policy(self) -> Union[TopTwoTSPolicy, TSPostDiffPolicy, TSContextualPolicySimple]:
        return self.policy
